...
Currently, only the latest release of SQL Easy is actively supported with security updates.
...
3. Attach any relevant logs (scrubbed of real targets).

We will try to acknowledge your report within 48 hours and work with you to patch the system immediately.
