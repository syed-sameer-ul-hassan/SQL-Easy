...
A clear and concise description of what you want to happen. If you are suggesting a code change, please specify which files or modules (`core/recon.py`, `core/scanner.py`, `core/logging.py`, `core/config.py`, etc.) are affected.
