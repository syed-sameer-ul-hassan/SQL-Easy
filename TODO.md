...
- [ ] Add multiple tamper script rotation (`--tamper=between,randomcase,space2comment`)
...
- [ ] Add config file support (`config.yaml`) for saving default flags per-project
- [ ] Add `--target-list` flag for multi-domain batch scanning

### Output & Reporting
- [ ] Add HTML report generation with summary statistics
- [ ] Add auto-screenshot of confirmed vulnerable pages using `gowitness`
